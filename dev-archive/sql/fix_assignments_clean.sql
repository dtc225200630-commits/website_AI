-- ==========================================
-- CÁCH 1: XÓA TẤT CẢ DỮ LIỆU CŨ RỒI TẠO LẠI (CLEAN SLATE)
-- ==========================================

-- Xóa tất cả dữ liệu (sẽ xóa lớp cũ, bài tập cũ, nhưng GIỮ teachers & students)
TRUNCATE TABLE agent_logs CASCADE;
TRUNCATE TABLE evaluation_sessions CASCADE;
TRUNCATE TABLE submissions CASCADE;
TRUNCATE TABLE assignment_testcases CASCADE;
TRUNCATE TABLE assignment_requirements CASCADE;
...
ALTER SEQUENCE assignment_requirements_requirement_id_seq RESTART WITH 1;
ALTER SEQUENCE assignment_testcases_testcase_id_seq RESTART WITH 1;

-- ==========================================
-- TẠO LẠI CLASSES CHO TẤT CẢ GIÁO VIÊN
-- ==========================================

-- Explicitly set class_id values to ensure they match expected values
INSERT INTO classes (class_id, class_name, teacher_id, semester, academic_year)
VALUES
(1, 'Lap trinh Python KTPM', 1, 'HK1', '2025-2026'),
(2, 'Lap trinh Python K64', 2, 'HK1', '2025-2026'),
(3, 'Lap trinh Python K65', 3, 'HK1', '2025-2026'),
(4, 'Lap trinh Python K66', 4, 'HK1', '2025-2026');
...
-- Ensure class_id values in enrollments match those in classes
INSERT INTO enrollments (class_id, student_id)
SELECT c.class_id, s.student_id
FROM classes c
CROSS JOIN (SELECT generate_series(1, 10) AS student_id) s
WHERE c.class_id IN (1, 2, 3, 4);

-- ==========================================
-- THÊM ASSIGNMENTS CHO CẤC GIÁO VIÊN
-- ==========================================

-- TEACHER 1 (Class 1) - 1 bài
INSERT INTO assignments (class_id, title, description, due_date, programming_language)
VALUES (1, 'Viết chương trình cộng 2 số', 'Nhập 2 số và in ra tổng', '2026-12-30 23:59:00', 'Python');
...
-- ==========================================
-- THÊM REQUIREMENTS CHO TẤT CẢ ASSIGNMENTS
-- ==========================================

-- Assignment 1 - Cộng 2 số
INSERT INTO assignment_requirements (assignment_id, requirement_text, weight) VALUES (1, 'Có dùng input()', 10);
INSERT INTO assignment_requirements (assignment_id, requirement_text, weight) VALUES (1, 'Có phép cộng', 10);
INSERT INTO assignment_requirements (assignment_id, requirement_text, weight) VALUES (1, 'Có print()', 10);
...
-- ==========================================
-- THÊM TEST CASES CHO TẤT CẢ ASSIGNMENTS
-- ==========================================

-- Assignment 1
INSERT INTO assignment_testcases (assignment_id, input_data, expected_output, score_weight) VALUES (1, '2\n3\n', '5', 10);
INSERT INTO assignment_testcases (assignment_id, input_data, expected_output, score_weight) VALUES (1, '10\n20\n', '30', 10);
INSERT INTO assignment_testcases (assignment_id, input_data, expected_output, score_weight) VALUES (1, '7\n8\n', '15', 10);
