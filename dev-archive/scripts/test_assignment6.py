"""Test script for Assignment 6: Factorial"""
import sys
import os
import tempfile
import psycopg2
...
def test_assignment6():
	"""Test assignment 6 with all test cases from the database."""
	
	assignment_id = 6
	
	# Read solution
	with open("solution_assignment6.py", "r") as f:
	...
	print(f"Assignment {assignment_id}: Factorial")
